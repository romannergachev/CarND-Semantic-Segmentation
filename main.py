...
def load_vgg(sess, vgg_path):
    ...
    layer3_out  = model.get_tensor_by_name('layer3_out:0')
    layer4_out  = model.get_tensor_by_name('layer4_out:0')
    layer7_out  = model.get_tensor_by_name('layer7_out:0')
...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    kernel_init = tf.truncated_normal_initializer(stddev=KERNEL_STDDEV)

    stride   = 2
    stride8  = 8
    kernel   = 1
    kernel4  = 4
    kernel16 = kernel4 * kernel4
    filters = 256
    ...
    combination1 = tf.add(conv4, upsample1)
    ...
    combination2 = tf.add(conv3, upsample2)

    upsample3 = tf.layers.conv2d_transpose(
        combination2,
        num_classes,
        kernel16,
        stride8,
